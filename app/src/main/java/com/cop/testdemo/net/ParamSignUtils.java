...
public class ParamSignUtils {
	...
	public static void main(String[] args)
	{
		...
		signMap.put("deviceMark","867271034433408");
		signMap.put("timestamp","1536052547873");
		signMap.put("version","5.0.0");
		signMap.put("channelMark","JJC000001");
		signMap.put("account","555");
		signMap.put("password","633de4b0c14ca52ea2432a3c8a5c4c31");
		signMap.put("username","xxx");
		signMap.put("gender","1");
		signMap.put("age","19");
		signMap.put("telephone","1213456");
		String secret="registeredInterface";
